...
int ckptlog_create(ts_thread_struct_t *, ts_ckptlog_t *, unsigned long,
		   unsigned short, bool);
void ckptlog_destroy(ts_ckptlog_t *, ts_ckptlog_t *);
ts_ckpt_entry_t *ckptlog_enq(ts_ckptlog_t *, unsigned long, unsigned long,
			     ts_cpy_hdr_struct_t *, bool);
...
void ckptlog_reclaim(ts_ckptlog_t *, ts_ckptlog_t *);
void ckptlog_flush(ts_ckptlog_t *, ts_ckptlog_t *);
